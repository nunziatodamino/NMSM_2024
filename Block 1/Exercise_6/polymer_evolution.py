...
for k, beta in enumerate(beta_list):
    ee2_results[k], end_height_results[k], energy_evolution_results[k], gyr_radius_results[k] = polymer.thermalization(monomers_initial_conf, time_max, beta)
...
plt.suptitle("Evolution of Observables for Different Beta Values", fontsize=25)
